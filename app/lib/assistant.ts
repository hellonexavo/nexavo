...
- Starter Website, from €199: a professional one-page website, mobile responsive design, contact or enquiry form, basic SEO, deployment, and one revision.
- Business Website, from €399: a larger business website focused on services, credibility, useful lead forms, and a clear customer journey.
- Business Automation, from €349: focused lead capture, email notifications, confirmations, follow-ups, routing, and practical business-tool connections.
- AI Assistant & Automation, from €499: website assistance, customer information capture, lead qualification, service guidance, AI-assisted workflows, and appropriately scoped integrations.
...
export function fallbackAssistantReply(message: string) {
  ...
  if (/(\bai\b|assistant|faq|questions|qualif)/.test(text)) return "AI Assistant & Automation starts from €499 and can answer common questions, collect useful details, qualify leads, and guide customers toward the right service. The exact workflow and integrations are confirmed during scoping.";
  if (/(automation|workflow|email|notification|routing|spreadsheet|crm|reminder)/.test(text)) return "Business Automation starts from €349 for focused processes such as notifications, follow-ups, routing, reminders, or structured data handling. If the workflow needs an AI assistant or AI-assisted decisions, AI Assistant & Automation starts from €499.";
  if (/(price|cost|package|website|landing|seo|mobile)/.test(text)) return "Starter Website starts from €199, Business Website from €399, Business Automation from €349, and AI Assistant & Automation from €499. Tell me the result you need and I’ll suggest the clearest starting point.";
