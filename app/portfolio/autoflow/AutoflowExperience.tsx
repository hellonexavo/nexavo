...
export default function AutoflowExperience() {
  ...
  return (
    <main id="top" className="min-h-screen overflow-hidden bg-[#0a0d10] text-[#f4f7f8] selection:bg-[#d8ff3e] selection:text-black">
      ...
      <section className="bg-[#0d1115] px-5 py-20 sm:px-7 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col gap-7 rounded-[24px] border border-white/10 bg-[#11161a] p-7 sm:flex-row sm:items-center sm:justify-between sm:p-10"><div><p className="text-xs font-bold uppercase tracking-[0.22em] text-[#d8ff3e]">A YY Builds portfolio concept</p><h2 className="mt-3 text-2xl font-black uppercase sm:text-3xl">Want a service platform like this?</h2><p className="mt-2 text-sm text-white/45">Start a booking and automation project for your own business.</p></div><PurchaseButton productId="booking-automation" className="shrink-0">Start this type of project</PurchaseButton></div></section>
