...
export default function AutoflowExperience() {
  ...
  return (
    <main id="top" className="min-h-screen overflow-hidden bg-[#0a0d10] text-[#f4f7f8] selection:bg-[#d8ff3e] selection:text-black">
      ...
      <footer className="px-5 py-10 sm:px-7 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 text-sm text-white/35 sm:flex-row sm:items-center"><div><p className="font-black uppercase text-white">Autoflow</p><p className="mt-1">Auto-service website concept created by Nexavo.</p></div><div className="flex items-center gap-5"><a href="#top" className="hover:text-white">Back to top</a><Link href="/#work" className="rounded-lg border border-white/15 px-5 py-3 font-bold text-white hover:border-[#d8ff3e] hover:text-[#d8ff3e]">Back to Nexavo portfolio →</Link></div></div></footer>
    </main>
  );
}
