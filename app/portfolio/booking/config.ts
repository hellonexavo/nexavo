...
export const copy = {
  en: {
    ...
    estimateNote: "Demo estimate · Sandbox checkout available",
    ...
    privacy: "Booking details stay in this browser. PayPal handles the sandbox payment securely.",
    ...
    footerConcept: "YY Booking — portfolio demo concept",
  ...
  nl: {
    ...
    estimateNote: "Demo-indicatie · Sandboxbetaling beschikbaar",
    ...
    privacy: "Boekingsgegevens blijven in deze browser. PayPal verwerkt de sandboxbetaling veilig.",
    ...
    footerConcept: "YY Booking — demoportfolioconcept",
