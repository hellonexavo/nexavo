...
function StudioContent() {
  return <>
    ...
    <section className="studio-sales"><div className="studio-shell"><div><p className="studio-eyebrow">Like this booking experience?</p><h2>YY Booking Template</h2><p>Own the full customizable source code, tailored to your project.</p></div><div className="studio-sales-price"><strong>Get a quote</strong><span>Pricing based on scope</span></div><div className="studio-actions"><Link href="/#contact" className="studio-button studio-button-primary">Let&apos;s discuss your project <span>↗</span></Link><Link href="/" className="studio-button studio-button-secondary">Back to YY Builds <span>←</span></Link></div></div></section>
  </>;
}
