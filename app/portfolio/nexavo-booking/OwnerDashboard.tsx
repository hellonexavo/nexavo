...
function Metric({ label, value, detail }: { label: string; value: string; detail: string }) { return <div className="min-w-0 rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm"><p className="break-words text-sm text-slate-500">{label}</p><p className="mt-3 break-words text-3xl font-semibold tracking-tight text-slate-950">{value}</p><p className="mt-2 break-words text-xs font-medium text-cyan-700">{detail}</p></div>; }
