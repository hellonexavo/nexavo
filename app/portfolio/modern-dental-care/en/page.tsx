...
export const metadata = createPageMetadata({
  title: "Aurelia Dental — Amsterdam | YY Builds",
  description: "Fictional dental concept project for Aurelia Dental, with demo locations, treatments and an appointment flow that sends no patient data.",
...
const services = [
  ...
  ["Aurelia Junior", "A calm, positive dental experience designed for children."],
];

const locations = [
  ["Amsterdam Centrum", "Voorbeeldstraat 82", "/portfolio/modern-dental-care/en/amsterdam-oost"],
  ["Amsterdam Noord", "Conceptstraat 214", "/portfolio/modern-dental-care/en/amsterdam-west"],
  ["Aurelia Junior", "Demolaan 36", "/portfolio/modern-dental-care/en/mdc-junior"],
];

export default function EnglishAureliaDentalPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f5ef] text-[#17332e]">
      <div className="bg-[#173f39] px-4 py-2 text-center text-[10px] font-semibold uppercase tracking-[0.16em] text-white/65">Concept project · Fictional clinic · No real healthcare provider</div>
      <header className="border-b border-[#173f39]/10 bg-[#f7f5ef]/90 backdrop-blur-xl">
        <div className="mx-auto flex min-h-20 max-w-[1440px] items-center justify-between gap-4 px-5 md:px-8 lg:px-12">
          <a href="/portfolio/modern-dental-care/en" className="text-[12px] font-semibold uppercase leading-4 tracking-[0.19em]">Aurelia<br />Dental</a>
