...
const locations = [
  { id: "oost", name: "Amsterdam Centrum", address: "Voorbeeldstraat 82" },
  { id: "west", name: "Amsterdam Noord", address: "Conceptstraat 214" },
  { id: "junior", name: "Aurelia Junior", address: "Demolaan 36" },
];
