...
export default function MaisonExperience() {
  ...
  return (
    <main className="min-h-screen bg-[#f4ecdd] text-[#2a1b14] selection:bg-[#9c3f2a] selection:text-white">
              ...
              {filteredDishes.map((dish) => (
                ...
                >
                  <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_auto] items-start gap-x-5 gap-y-3 sm:gap-x-7">
                    ...
                    <p className="shrink-0 pt-1 text-sm font-semibold tabular-nums text-[#9c3f2a] sm:text-base">
      ...
      <footer className="bg-[#251610] px-5 py-10 text-[#cdb8aa] sm:px-7 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col justify-between gap-7 sm:flex-row sm:items-center"><div><p className="font-serif text-2xl text-white">Maison</p><p className="mt-1 text-xs">Restaurant website concept created by Nexavo.</p></div><div className="flex flex-wrap items-center gap-5 text-sm"><a href="#top" className="hover:text-white">Back to top</a><Link href="/#work" className="rounded-full border border-white/20 px-5 py-3 font-semibold text-white hover:bg-white hover:text-[#251610]">Back to Nexavo portfolio →</Link></div></div></footer>
    </main>
  );
}
