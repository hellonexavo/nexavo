...
export default function MaisonExperience() {
  ...
  return (
    <main className="min-h-screen bg-[#f4ecdd] text-[#2a1b14] selection:bg-[#9c3f2a] selection:text-white">
      ...
      <section className="bg-[#eadcc7] px-5 pb-24 sm:px-7 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col gap-7 rounded-[30px] bg-[#251610] p-7 text-[#f7ead8] sm:flex-row sm:items-center sm:justify-between sm:p-10"><div><p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#d9936f]">A YY Builds portfolio concept</p><h2 className="mt-3 font-serif text-3xl">Want a restaurant site like this?</h2><p className="mt-2 text-sm text-[#c7b0a4]">Start a premium website project for your own business.</p></div><PurchaseButton productId="premium-website" className="shrink-0">Start this type of project</PurchaseButton></div></section>
