...
const projects = [
  ...
  { category: "Local cleaning business", built: "Web app · Instant quotes · Booking management", name: "YY Booking", title: "From cleaning estimate to confirmed booking.", description: "A complete service-booking concept with live quote calculations, scheduling, bilingual booking, and an owner dashboard.", href: "/portfolio/nexavo-booking", theme: "project-light project-blue", capabilities: ["Instant quote calculator", "Customer booking flow", "Owner dashboard"] },
];
